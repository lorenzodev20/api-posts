...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>API REST con Laravel</title>
    ...
    <body class="bg-gray-100 text-gray-700">
        <div class="container mx-auto px-4">
            <div class="lg:text-center my-10">
                <h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">Api rest con Laravel</h2>
                <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Listado de Posts publicados</p>
            </div>
